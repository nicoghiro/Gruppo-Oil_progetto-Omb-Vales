$(document).ready(function() {
    ...
    fetchValues("http://localhost/web_valves/values/" + measurementId + "?type=apertura", "apertura", "aperturaChart");
    fetchValues("http://localhost/web_valves/values/" + measurementId + "?type=chiusura", "chiusura", "chiusuraChart");
  });
